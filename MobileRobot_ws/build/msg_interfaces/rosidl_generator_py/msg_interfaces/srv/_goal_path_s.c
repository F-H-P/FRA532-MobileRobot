...
bool msg_interfaces__srv__goal_path__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interfaces.srv._goal_path.GoalPath_Request", full_classname_dest, 46) == 0);
  }
  msg_interfaces__srv__GoalPath_Request * ros_message = _ros_message;
  {  // x_path
...
PyObject * msg_interfaces__srv__goal_path__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interfaces.srv._goal_path");
...
ROSIDL_GENERATOR_C_EXPORT
bool msg_interfaces__srv__goal_path__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interfaces.srv._goal_path.GoalPath_Response", full_classname_dest, 47) == 0);
  }
  msg_interfaces__srv__GoalPath_Response * ros_message = _ros_message;
