...
#ifndef MSG_INTERFACES__SRV__DETAIL__SEND_POINT__FUNCTIONS_H_
#define MSG_INTERFACES__SRV__DETAIL__SEND_POINT__FUNCTIONS_H_
...
/// Initialize srv/SendPoint message.
/**
...
/// Finalize srv/SendPoint message.
/**
...
/// Create srv/SendPoint message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_interfaces__srv__SendPoint_Request__init().
...
/// Destroy srv/SendPoint message.
/**
 * It calls
 * msg_interfaces__srv__SendPoint_Request__fini()
...
/// Check for srv/SendPoint message equality.
/**
...
/// Initialize array of srv/SendPoint messages.
/**
...
/// Finalize array of srv/SendPoint messages.
/**
 * It calls
 * msg_interfaces__srv__SendPoint_Request__fini()
...
/// Create array of srv/SendPoint messages.
/**
 * It allocates the memory for the array and calls
 * msg_interfaces__srv__SendPoint_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SendPoint messages.
/**
 * It calls
 * msg_interfaces__srv__SendPoint_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendPoint message array equality.
/**
...
/// Copy an array of srv/SendPoint messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * msg_interfaces__srv__SendPoint_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interfaces
...
/**
 * It calls
 * msg_interfaces__srv__SendPoint_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interfaces
...
/**
 * It allocates the memory for the array and calls
 * msg_interfaces__srv__SendPoint_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_msg_interfaces
...
/**
 * It calls
 * msg_interfaces__srv__SendPoint_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MSG_INTERFACES__SRV__DETAIL__SEND_POINT__FUNCTIONS_H_
