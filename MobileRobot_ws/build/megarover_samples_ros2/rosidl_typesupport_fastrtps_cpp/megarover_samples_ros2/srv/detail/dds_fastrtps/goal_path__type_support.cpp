...
#include "megarover_samples_ros2/srv/detail/goal_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const megarover_samples_ros2::srv::GoalPath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<megarover_samples_ros2::srv::GoalPath_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_megarover_samples_ros2
const rosidl_message_type_support_t *
get_message_type_support_handle<megarover_samples_ros2::srv::GoalPath_Request>()
{
  return &megarover_samples_ros2::srv::typesupport_fastrtps_cpp::_GoalPath_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const megarover_samples_ros2::srv::GoalPath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<megarover_samples_ros2::srv::GoalPath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &megarover_samples_ros2::srv::typesupport_fastrtps_cpp::_GoalPath_Response__handle;
}
...
{
  return &megarover_samples_ros2::srv::typesupport_fastrtps_cpp::_GoalPath__handle;
}
