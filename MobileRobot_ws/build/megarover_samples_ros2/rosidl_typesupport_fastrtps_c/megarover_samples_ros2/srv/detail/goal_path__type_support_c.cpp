...
#include "megarover_samples_ros2/srv/detail/goal_path__rosidl_typesupport_fastrtps_c.h"
...
#include "megarover_samples_ros2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_megarover_samples_ros2
...
using _GoalPath_Request__ros_msg_type = megarover_samples_ros2__srv__GoalPath_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_megarover_samples_ros2
size_t get_serialized_size_megarover_samples_ros2__srv__GoalPath_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoalPath_Request__ros_msg_type * ros_message = static_cast<const _GoalPath_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GoalPath_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_megarover_samples_ros2__srv__GoalPath_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_megarover_samples_ros2
size_t max_serialized_size_megarover_samples_ros2__srv__GoalPath_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GoalPath_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_megarover_samples_ros2__srv__GoalPath_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, megarover_samples_ros2, srv, GoalPath_Request)() {
...
using _GoalPath_Response__ros_msg_type = megarover_samples_ros2__srv__GoalPath_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_megarover_samples_ros2
size_t get_serialized_size_megarover_samples_ros2__srv__GoalPath_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GoalPath_Response__ros_msg_type * ros_message = static_cast<const _GoalPath_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_megarover_samples_ros2__srv__GoalPath_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_megarover_samples_ros2
size_t max_serialized_size_megarover_samples_ros2__srv__GoalPath_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GoalPath_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_megarover_samples_ros2__srv__GoalPath_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, megarover_samples_ros2, srv, GoalPath_Response)() {
...
// already included above
// #include "megarover_samples_ros2/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "megarover_samples_ros2/srv/goal_path.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, megarover_samples_ros2, srv, GoalPath)() {
