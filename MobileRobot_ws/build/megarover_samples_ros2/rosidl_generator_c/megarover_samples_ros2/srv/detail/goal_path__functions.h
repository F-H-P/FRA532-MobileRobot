...
#ifndef MEGAROVER_SAMPLES_ROS2__SRV__DETAIL__GOAL_PATH__FUNCTIONS_H_
#define MEGAROVER_SAMPLES_ROS2__SRV__DETAIL__GOAL_PATH__FUNCTIONS_H_
...
#include "megarover_samples_ros2/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_megarover_samples_ros2
bool
 ...
 * calls
 * megarover_samples_ros2__srv__GoalPath_Request__init().
...
/**
 * It calls
 * megarover_samples_ros2__srv__GoalPath_Request__fini()
 ...
 * megarover_samples_ros2__srv__GoalPath_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * megarover_samples_ros2__srv__GoalPath_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * megarover_samples_ros2__srv__GoalPath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_megarover_samples_ros2
...
/**
 * It calls
 * megarover_samples_ros2__srv__GoalPath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_megarover_samples_ros2
...
/**
 * It allocates the memory for the array and calls
 * megarover_samples_ros2__srv__GoalPath_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_megarover_samples_ros2
...
/**
 * It calls
 * megarover_samples_ros2__srv__GoalPath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MEGAROVER_SAMPLES_ROS2__SRV__DETAIL__GOAL_PATH__FUNCTIONS_H_
